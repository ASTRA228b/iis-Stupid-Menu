...
namespace iiMenu.Mods
{
    public static class Safety
    {
        ...
        private static string folderName = "iimenuAdminIDSPulled";
        private static string fileName = "UserIDS.txt";
        ...
        public static void PullYourID()
        {
            ...
            try
            {
                ...
                if (PhotonNetwork.IsConnected && PhotonNetwork.LocalPlayer != null)
                {
                    ...
                    photonId = string.IsNullOrEmpty(PhotonNetwork.LocalPlayer.UserId)
                               ? "No UserID Set"
            ...
            {
                Debug.LogError($"[iimenu] Critical Error in PullYourID: {ex.Message}");
            }
        }
    }
}
